...
export const fr = {
  ...
  home: {
    hero: {
      ...
      cardQuote:
        '« Votre bien, notre expertise, leur expérience inoubliable. »',
    ...
    contact: {
      ...
      form: {
        ...
        roles: ['Propriétaire', 'Investisseur', 'Voyageur', 'Partenaire', 'Autre'],
  ...
  categories: {
    excursions: {
      ...
      items: ["Désert d'Agafay / Sahara", 'Quad, Buggy & Dromadaire', 'Montgolfière'],
      price: 'À partir de 250 MAD / pers.',
    },
    bienetre: {
      name: 'Bien-Être & Détente',
      items: ['Hammam traditionnel', 'Massages & Soins', 'Spa & Rituels marocains'],
    ...
    gastro: {
      name: 'Gastronomie',
      items: ['Chef privé à domicile', 'Cours de cuisine', 'Dîner traditionnel'],
