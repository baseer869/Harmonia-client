...
export const en: Dictionary = {
  ...
  home: {
    hero: {
      ...
      cardQuote:
        '“Your property, our expertise, their unforgettable experience.”',
  ...
  categories: {
    excursions: {
      ...
      items: ['Agafay / Sahara desert', 'Quad, Buggy & Camel', 'Hot-air balloon'],
      price: 'From 250 MAD / person',
    },
    bienetre: {
      name: 'Wellness & Relaxation',
      items: ['Traditional hammam', 'Massages & Treatments', 'Moroccan spa & rituals'],
