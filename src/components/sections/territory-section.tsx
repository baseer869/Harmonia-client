  ...
  return (
    ...
    >
      <div className="eyebrow">
        {en ? 'Our Territory' : 'Notre Territoire'}
      </div>
      ...
      <div className="mx-auto! w-full max-w-[1040px]">
        ...
        <div className="relative mx-auto w-full overflow-hidden rounded-[12px] border border-[rgba(201,168,76,0.28)] bg-[#0a0f1a] shadow-[0_18px_45px_rgba(0,0,0,0.45)]">
          <iframe
            title={en ? 'Morocco Map' : 'Carte du Maroc'}
            src="https://www.openstreetmap.org/export/embed.html?bbox=-13.392333984375002%2C27.566721430409707%2C-0.9228515625000001%2C36.36711218750605&amp;layer=mapnik&amp;marker=31.6294723%2C-7.9810845"
            loading="lazy"
            className="block h-[450px] w-full border-0 max-[768px]:h-[430px]"
            style={{
              filter:
                'sepia(0.22) saturate(0.78) contrast(0.95) brightness(0.88)',
            }}
          />

          {/* soft luxury overlay */}
          <div className="pointer-events-none absolute inset-0 bg-[linear-gradient(180deg,rgba(10,10,10,0.12)_0%,rgba(10,10,10,0.18)_55%,rgba(10,10,10,0.38)_100%)]" />

          {/* subtle gold frame */}
          <div className="pointer-events-none absolute inset-0 rounded-[12px] ring-1 ring-[rgba(201,168,76,0.2)]" />
        </div>
        ...
        <div className="mt-4 min-h-[22px] text-center">
          <span className="text-[12px] text-text-muted">
            {en
              ? 'Real map view · Marrakech marked as headquarters'
              : 'Carte réelle · Marrakech indiquée comme siège principal'}
          </span>
        </div>

        {/* info strip */}
        <div className="mt-7 flex flex-wrap justify-center gap-12 max-[600px]:gap-7">
          {[
            { n: '7', l: en ? 'Cities covered' : 'Villes couvertes' },
            { n: '1', l: en ? 'HQ · Marrakech' : 'Siège · Marrakech' },
            { n: '100%', l: en ? 'Morocco · Local' : 'Maroc · Local' },
            ...
            <div key={s.l} className="text-center">
              <span className="block font-display text-[22px] text-gold">
                {s.n}
              </span>

              <span className="text-[9px] uppercase tracking-[3px] text-text-muted">
                {s.l}
              </span>
            </div>
          ))}
